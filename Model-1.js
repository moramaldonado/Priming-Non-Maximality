var shuffleSequence =  seq("agreement","instr", shuffle("practice"),"quest","sr","code")
...
var items = [
    ["sep", "Separator2", {transfer: 1000, normalMessage: "+"}],
    ['agreement', "NewForm", {html: {include: 'agreement_EN.html'}}],
    ['instr',"NewMessage", {html: {include: 'instructions.html'}}],

    ['practice', "Sentence", {html: "<center>Between four and ten dots are below the line.</center> <br> <center> <img src='https://dl.dropboxusercontent.com/u/13340774/Images/white.png' border='2'> </center>"},
     "SubHtmlFlash", {html:"<center>Between four and ten dots are below the line.</center> <br> <center> <img src='https://dl.dropboxusercontent.com/u/13340774/Images/False_A_dots_blue_square_below_.png' border='2'></center>", q:""}],
